    ...
    return (
      <Fragment>
        <nav className="pagination-holder" aria-label='Pagination'>
              ...
              if (page === LEFT_PAGE)
                return (
                  <li>
                    <Link
                      key={index}
                      to={this.props.path + '?page=' + this.state.currentPage + this.pageNeighbours * 2 - 1}
          ...
          <Link
            to={this.props.path + '?page=' + maxCap(currentPage + 1, this.totalPages)}
            onClick={() => {
