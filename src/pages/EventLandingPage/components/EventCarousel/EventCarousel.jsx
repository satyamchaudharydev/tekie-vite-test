...
const EventCarousel = props => {
  ...
  const makeActiveSlide = (activeVal) => {
    if(transitioning) return
    setState({
      ...state,
      translate: 0,
      activeSlide: activeVal
    })
  }
  ...
  console.log(_slides)
  return (
    <div className='eventCarousel-container' ref={sliderRef}>
      <SliderContent
        translate={translate}
      ...
      <Dots slides={slides} activeSlide={activeSlide} makeActiveSlide={makeActiveSlide} />
    </div>
  )
}
