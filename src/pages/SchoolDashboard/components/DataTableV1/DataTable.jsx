...
export default class DataTable extends React.Component {
  ...
  renderHeadingRow = (_cell, cellIndex) => {
    const {columns, headerClassName} = this.props;
  ...
  renderRow = (_row, rowIndex) => {
    ...
    return (
      <tr key={`row-${rowIndex}`} className='dataTable-table-row'>
  ...
  render() {
    const { columns, tableData, tableHeight, isLoading, rowClassName, tablePadding } = this.props;
    ...
    return (
      <div className="DataTable" id='DataTable'>
        <div className="dataTable-ScrollContainer" style={{ maxHeight: tableHeight, padding: tablePadding || 'inherit' }}>
